...
# 📘 Script 1: `compression_config.py`
...
```bash
python main.py --dataset_path data.csv --kd_alpha 0.5
```
...
**Ready for the next script? The next one is `data.py` which handles data loading and the critical tokenization caching feature.**
